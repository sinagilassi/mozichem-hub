...
# NOTE: new mixed reference with string
HEADER_CONTENT = """
# This is a sample reference file in YAML format
# It contains metadata and reference data for chemical species
:
"""
...
Generated by Mozichem Hub
"""

# combine
REFERENCE_CONTENT = HEADER_CONTENT + REFERENCE_CONTENT + FOOTER_CONTENT
